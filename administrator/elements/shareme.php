...
class JFormFieldShareMe extends JFormField {
    ...
    protected function getInput() {
    	...
    	// links
		$link_jed = 'https://extensions.joomla.org/extensions/extension/contacts-and-feedback/contact-forms/digi-contact/';
		$link_products = 'https://www.digigreg.com/en/products.html';
		$link_documentation = 'https://www.digigreg.com/en/wiki/digi-contact.html';
